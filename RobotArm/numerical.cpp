...
void Numerical::ludcmp(double *A, int n, uint* indx, double d, double *fac)
{
	int i, imax, j, k;
	double big, temp;
...
void Numerical::lubksb(double *a, int n, uint* indx, double *b, double *x)
{
	int i, ii = 0, ip, j;
	double sum;
